// BUG-6 FIX: Renamed from extractionService.ts to extractionService.js.
// The file contains no TypeScript-specific syntax; renaming avoids the brittle
// "copy .ts file as .mjs and dynamic-import" pattern used in the original test.
